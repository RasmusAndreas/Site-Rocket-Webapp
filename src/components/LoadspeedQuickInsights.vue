...
export default {
    ...
    data() {
        return {
            allLoadtimes: [],
            loadData: this.allLoadtimesCalc(),
        }
    },
    props: {
        urls: {
